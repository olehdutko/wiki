...
function getItemSlug(item) {
    ...
    return name.toLowerCase().replace(/[^a-z0-9\u0430-\u044f\u0451\u0401\u0490\u0491\u0404\u0454\u0406\u0456\u0407\u0457]/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '');
}
...
async function main() {
    ...
    const mapping = JSON.parse(fs.readFileSync('/Users/odutko/projects/wiki/item_id_mapping_v2.json', 'utf8'));
