...
const weaponItemValidation = [
    ...
    body('guard_width').notEmpty().isString().isLength({ max: 20 }),
    ...
    body('apple').notEmpty().isString().isLength({ max: 10 }),
...
router.put('/apple/:id', namedEntityValidation, appleController.update.bind(appleController));
...
router.put('/blade-type/:id', namedEntityValidation, bladeTypeController.update.bind(bladeTypeController));
...
router.put('/dolls/:id', namedEntityValidation, dollsController.update.bind(dollsController));
...
router.put('/epoha/:id', namedEntityValidation, epohaController.update.bind(epohaController));
...
router.put('/global-type/:id', namedEntityValidation, globalTypeController.update.bind(globalTypeController));
...
router.put('/guard-type/:id', namedEntityValidation, guardTypeController.update.bind(guardTypeController));
...
router.put('/sharpening/:id', namedEntityValidation, sharpeningController.update.bind(sharpeningController));
...
router.put('/usage/:id', namedEntityValidation, usageController.update.bind(usageController));
...
router.put('/categories/:id', categoryValidation, categoryController.update.bind(categoryController));
...
router.put('/weapons/:id', weaponItemValidation, weaponItemController.updateWeapon.bind(weaponItemController));
